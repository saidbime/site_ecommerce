...
if($_SERVER['REQUEST_METHOD'] == "POST"){ 
    ...
    /** Traitement Table Work */
        try{
            if(isset($_POST['name']) && isset($_POST['image']) && isset($_POST['description']) && isset($_POST['prix'])){
                ...
                $prix = (int)$_POST['prix'];
                if(!empty($image)){
                    $query = "update items set name_item=$name,image_item='$image',description=$description,prix=$prix where id_item=$id_item";

                }else{
                    $query = "update items set name_item=$name,description=$description,prix=$prix where id_item=$id_item";
...
$select = $db->query('SELECT id_item, name_item,image_item, description,  prix FROM items where id_item = '.Session::get('id_item_edit'));
            ...
            <div class="row">
                <form method="POST" action="">
                    ...
                    <div class="form-group tdImg">
                        <img id="imageWorks" src="admin/product_images/<?=$item['image_item']; ?>" alt="">
                        <input class="input" type="file" name="image" value="C:\xampp\htdocs\siteeom\admin\product_images\<?=$item['image_item']; ?>">   
                    </div>
