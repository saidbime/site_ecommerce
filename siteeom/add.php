...
if($_SERVER['REQUEST_METHOD'] == "POST"){ 
    ...
    /** Traitement Table Work */
        try{
            if(isset($_POST['name_item']) && isset($_POST['image_item'])  && isset($_POST['description']) && isset($_POST['prix'])){
                $name = $db->quote($_POST['name_item']);
                $image = $db->quote($_POST['image_item']);
                $description = $db->quote($_POST['description']);
                $prix = (int)$_POST['prix'];
                $query = "INSERT INTO items(name_item, image_item, description,  prix) VALUES ($name,$image,$description,$prix)";
            ...
            <div class="row">
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name_item" aria-describedby="nameItem"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" name="image_item" id="exampleFormControlFile1">
                    </div>
