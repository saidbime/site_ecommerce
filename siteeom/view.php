        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-info">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="add.php">Ajouter Item</a>
                    </li>
                    <li class="nav-item">
        ...
        <table class="table" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $item['prix'];?>£</td>
                    <td class="d-flex justify-content-center mt-2"><img class="imgstyle" src="admin/product_images/<?= $item['image_item'];?>" alt=""> </td>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
